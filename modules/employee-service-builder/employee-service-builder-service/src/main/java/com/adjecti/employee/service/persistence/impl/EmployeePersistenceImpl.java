...
package com.adjecti.employee.service.persistence.impl;

import com.adjecti.employee.exception.NoSuchEmployeeException;
import com.adjecti.employee.model.Employee;
import com.adjecti.employee.model.EmployeeTable;
import com.adjecti.employee.model.impl.EmployeeImpl;
import com.adjecti.employee.model.impl.EmployeeModelImpl;
import com.adjecti.employee.service.persistence.EmployeePersistence;
import com.adjecti.employee.service.persistence.EmployeeUtil;
import com.adjecti.employee.service.persistence.impl.constants.PersistenceConstants;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public Employee findByemail_First(
	 ...
	 */
	@Override
	public Employee fetchByemail_First(
		String email, OrderByComparator<Employee> orderByComparator) {
	 ...
	 */
	@Override
	public Employee findByemail_Last(
			String email, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
	 ...
	 */
	@Override
	public Employee fetchByemail_Last(
		String email, OrderByComparator<Employee> orderByComparator) {
		...
		List<Employee> list = findByemail(
	 ...
	 */
	@Override
	public Employee[] findByemail_PrevAndNext(
		...
		try {
			...
			array[0] = getByemail_PrevAndNext(
				session, employee, email, orderByComparator, true);

			array[1] = employee;

			array[2] = getByemail_PrevAndNext(
				session, employee, email, orderByComparator, false);
	...
	protected Employee getByemail_PrevAndNext(
		Session session, Employee employee, String email,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_EMAIL_EMAIL_3 =
		"(employee.email IS NULL OR employee.email = '')";
