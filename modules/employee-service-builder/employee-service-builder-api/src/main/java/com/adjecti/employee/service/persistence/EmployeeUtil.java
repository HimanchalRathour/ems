...
package com.adjecti.employee.service.persistence;
...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.adjecti.employee.exception.NoSuchEmployeeException {
	 ...
	 * @return the ordered range of matching employees
	 */
	public static List<Employee> findByemail(
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByemail_First(
	 ...
	 * @return the first matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByemail_First(
		String email, OrderByComparator<Employee> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByemail_Last(
			String email, OrderByComparator<Employee> orderByComparator)
		throws com.adjecti.employee.exception.NoSuchEmployeeException {
	 ...
	 * @return the last matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByemail_Last(
		String email, OrderByComparator<Employee> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee[] findByemail_PrevAndNext(
			long employeeId, String email,
			OrderByComparator<Employee> orderByComparator)
		throws com.adjecti.employee.exception.NoSuchEmployeeException {

		return getPersistence().findByemail_PrevAndNext(
			employeeId, email, orderByComparator);
	}
