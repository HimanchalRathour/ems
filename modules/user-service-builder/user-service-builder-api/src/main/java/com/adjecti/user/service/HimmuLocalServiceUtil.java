...
/**
 * Provides the local service utility for Himmu. This utility wraps
 * <code>com.adjecti.user.service.impl.HimmuLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HimmuLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.user.service.impl.HimmuLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Himmu addHimmu(Himmu himmu) {
		return getService().addHimmu(himmu);
	}
	 ...
	 */
	public static Himmu createHimmu(long himmuId) {
		return getService().createHimmu(himmuId);
	}
	 ...
	 */
	public static Himmu deleteHimmu(Himmu himmu) {
		return getService().deleteHimmu(himmu);
	}
	 ...
	 */
	public static Himmu deleteHimmu(long himmuId) throws PortalException {
		return getService().deleteHimmu(himmuId);
	}
	...
	public static Himmu fetchHimmu(long himmuId) {
		return getService().fetchHimmu(himmuId);
	}
	 ...
	 */
	public static Himmu fetchHimmuByUuidAndGroupId(String uuid, long groupId) {
		return getService().fetchHimmuByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a himmu with the primary key could not be found
	 */
	public static Himmu getHimmu(long himmuId) throws PortalException {
		return getService().getHimmu(himmuId);
	}
	 ...
	 */
	public static Himmu getHimmuByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return getService().getHimmuByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Himmu> getHimmus(int start, int end) {
		return getService().getHimmus(start, end);
	}
	 ...
	 */
	public static List<Himmu> getHimmusByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getHimmusByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Himmu> getHimmusByUuidAndCompanyId(
		...
		return getService().getHimmusByUuidAndCompanyId(
	 ...
	 */
	public static int getHimmusCount() {
		return getService().getHimmusCount();
	}
	 ...
	 */
	public static Himmu updateHimmu(Himmu himmu) {
		return getService().updateHimmu(himmu);
	}

	public static HimmuLocalService getService() {
		return _service;
	}

	private static volatile HimmuLocalService _service;
