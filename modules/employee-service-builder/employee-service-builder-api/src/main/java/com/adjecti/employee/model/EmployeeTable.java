...
/**
 * The table class for the &quot;employeeDetails&quot; database table.
 *
...
public class EmployeeTable extends BaseTable<EmployeeTable> {
	...
	public final Column<EmployeeTable, String> password = createColumn(
	...
	private EmployeeTable() {
		super("employeeDetails", EmployeeTable::new);
	}
