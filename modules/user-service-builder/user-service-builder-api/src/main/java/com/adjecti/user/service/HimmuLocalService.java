...
/**
 * Provides the local service interface for Himmu. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HimmuLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HimmuLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.user.service.impl.HimmuLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the himmu local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HimmuLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Himmu> getHimmusByUuidAndCompanyId(String uuid, long companyId);
